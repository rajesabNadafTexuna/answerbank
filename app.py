...
def get_claude_llm():
    # Create the Anthropic Model using BedrockChat
...
def main():
    ...
    # Add a button that redirects to a different site
    redirect_button = st.button("Go to answer-bank.web.app")
    if redirect_button:
        st.markdown("""
            <a href="https://answer-bank.web.app/table?mode=question" target="_blank">
                <button style="background-color: #4CAF50; color: white; padding: 10px 24px; border: none; cursor: pointer; font-size: 16px;">
                    Go to answer-bank.web.app
                </button>
            </a>
